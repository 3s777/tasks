                                    ...
                                    <div class="row">
                                        ...
                                        foreach ($images as $image) { ?>
                                            <div class="col-md-3 image">
                                                <img src="img/demo/gallery/<?php echo $image['image']?>" style="max-width: 100%">
                                                <a class="btn btn-danger" href="/task_15_1_handler.php?id=<?php echo $image['id']?>" onclick="confirm('Вы уверены?');">Удалить</a>
                                            </div>
                                        <?php } ?>
                                    </div>
                                </div>
